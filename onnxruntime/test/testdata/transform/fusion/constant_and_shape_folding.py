...
graph_def = helper.make_graph(
    ...
    'constant_and_shape_folding_model',
    [X],
    [Y],
...
onnx.save(model_def, 'constant_and_shape_folding.onnx')
...
graph_def = helper.make_graph(
    ...
    'constant_and_shape_folding_with_scalar_shape_model',
    [X],
    [Y]
)
...
# Create the model (ModelProto)
model_def = helper.make_model(graph_def, producer_name='onnx-example', **kwargs)
onnx.save(model_def, 'constant_and_shape_folding_with_scalar_shape.onnx')
